export const translations = {
  en: {
    ...
    subscription: {
      ...
      agreeSubscribeOutro: ".",
      agreeTermsLabel: "Terms of Use",
      agreePrivacyLabel: "Privacy Policy",
...
`.trim(),
  ...
  zh: {
    ...
    subscription: {
      ...
      agreeSubscribeOutro: "。",
      agreeTermsLabel: "使用条款",
      agreePrivacyLabel: "隐私政策",
      mostPopular: "最受欢迎",
      activating: "…",
...
`.trim(),
  ...
  fr: {
    ...
    subscription: {
      ...
      agreeSubscribeOutro: ".",
      agreeTermsLabel: "Conditions d’utilisation",
      agreePrivacyLabel: "Politique de confidentialité",
