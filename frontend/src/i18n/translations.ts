export const translations = {
  en: {
    ...
    camera: {
      ...
      freeScanLimitText:
        "You have used your 3 free scans. Sign in to unlock more scans and save your journey.",
      goSignIn: "Sign in",
      later: "Maybe later",
    },
    collection: {
    ...
    subscription: {
      ...
      proMonthlyPlan: "PRO MONTHLY",
      proYearlyPlan: "PRO YEARLY",
      changePlan: "CHANGE PLAN",
      startPro: "START PRO",
      cancelAnytime: "Cancel anytime",
      freePlanSubtitle: "3 Scans / Day",
      scanPackPrice: "£1.99",
...
`.trim(),
  ...
  zh: {
    ...
    camera: {
      ...
      freeScanLimitText: "未登录状态下可免费识别 3 次，登录后可继续使用并同步收藏。",
      goSignIn: "去登录",
      later: "稍后再说",
    },
    collection: {
...
`.trim(),
  ...
  fr: {
    ...
    camera: {
      ...
      freeScanLimitText:
        "Vous avez utilisé vos 3 scans gratuits. Connectez-vous pour continuer à scanner et enregistrer votre parcours.",
    ...
    subscription: {
      ...
      scanPackPlan: "PACK DE SCANS",
      proMonthlyPlan: "PRO MENSUEL",
      proYearlyPlan: "PRO ANNUEL",
      changePlan: "CHANGER DE PLAN",
      startPro: "DÉMARRER PRO",
      cancelAnytime: "Annulez à tout moment",
      freePlanSubtitle: "3 scans / jour",
      scanPackPrice: "£1.99",
      scanPackSubtitle: "50 scans",
