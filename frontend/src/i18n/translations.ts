export const translations = {
  en: {
    ...
    result: {
      ...
      dailyQuotaExceededText: "You have used your daily scan quota. Please try again tomorrow.",
...
`.trim(),
  ...
  zh: {
    ...
    result: {
      ...
      dailyQuotaExceededText: "你今天的识别次数已达到上限，请明天再试。",
      needLoginTitle: "需要登录",
...
`.trim(),
  ...
  fr: {
    ...
    result: {
      ...
      dailyQuotaExceededText: "Vous avez atteint votre limite de scans du jour. Veuillez réessayer demain.",
